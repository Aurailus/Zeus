...
//    }
//
//    public MeshData(MeshChunk chunk, EncodedBlockChunk blockChunk, int resolution) {
...
//                    blocks[i][j][k] = blockChunk.getBlock(Math.round(i / resScale[resolution]), Math.round(j / resScale[resolution]), Math.round(k / resScale[resolution]));
//                }
//            }
//        }
//
